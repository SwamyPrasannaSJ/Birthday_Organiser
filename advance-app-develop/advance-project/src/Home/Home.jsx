    ...
    return (  
        <div>
            ...
            <div className='home-container'>
                ...
                <p id='p1' onClick={() => navigate('/about')}>Get In Touch</p>
            </div>
            <div className='sub1-container'>
                <h2 id='subscribe'> Crafting memories, one birthday at a time!</h2>
                <p><i>Your special day, our expert touch – HappyBash, where celebrations mean everything!</i></p>

                
            </div>
            <div className="hevents">
                <h1>SOME OF OUR WORKS</h1>
                <p><i>Elevating moments, transforming events – HappyBash Planners, where every detail is a masterpiece.</i></p>
            </div>
